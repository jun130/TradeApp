...
public class SearchBoardActivity extends AppCompatActivity{
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ItemData i = snapshot.getValue(ItemData.class);
                            if (i.getTitle().contains(extras.getString("searchValue")) | i.getContent().contains(extras.getString("searchValue"))) {
                                itemData.add(0, i);
                            }
                    }
                    ...
                    Toast.makeText(getApplicationContext(),extras.getString("searchValue") +" 관련 글이 존재하지 않습니다.", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public static class RecyclerTouchListener implements  RecyclerView.OnItemTouchListener {
        ...
        private SearchBoardActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final SearchBoardActivity.ClickListener clickListener) {
